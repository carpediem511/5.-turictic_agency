...
async function getData() {
    ...
    tours.forEach(tour => {
        ...
        <div class="relative">
            ...
            <div class="title flex flex-col absolute font-attention xl:mx-20 -my-24">
        ...
        <div class="flex flex-col info border drop-shadow-lg xl:mx-20 my-10">
            ...
            <div class="flex flex-col pb-10 pt-6 px-6">
                <div class="flex">
                    <img class="w-16 h-16" src="/src/images/icon-price.png">
                    <div class="font-basic text-rose-700 pt-6  pl-2 xl:text-3xl font-bold">${tour.price}</div>
                </div>

                <div class="flex">
                    <img class="w-12 h-12" src="/src/images/icon-rating.png">
